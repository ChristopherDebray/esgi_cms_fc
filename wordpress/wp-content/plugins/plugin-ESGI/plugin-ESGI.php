...
add_action('init', 'esgi_shortcode_skill_list');

function esgi_shortcode_skill_list() {
  add_shortcode( 'skills-list', 'skills_list_shortcode' );
}

function skills_list_shortcode( $atts ) {
  $toDisplay = "<h2>".$atts['title']."</h2>";
  $toDisplay .= "<ul>
    <li>Test</li>
    <li>Test 2</li>
    <li>Test 3</li>
